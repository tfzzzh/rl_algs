...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        rand_indices = np.random.randint(0, effective_size, size=(batch_size,))
        return {
    ...
    def __len__(self):
        return self.size # total points encountered
    ...
    def insert(
        ...
        the buffers are stored in a circular queue
        """
...
class MemoryEfficientReplayBuffer:
    ...
    def _insert_frame(self, frame: np.ndarray) -> int:
        ...
        self.framebuffer[self.framebuffer_idx] = frame # now state is framebuffer[:framebuffer_idx+1]
