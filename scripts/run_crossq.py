from rl_algs.agents.crossq import CrossQ
...
def run_training_loop(config: dict, logger: Logger, args: argparse.Namespace):
    ...
    assert (
        not discrete
    ), "Our crossq implementation only supports continuous action spaces. (This isn't a fundamental limitation, just a current implementation decision.)"
...
def main():
    ...
    logdir_prefix = "crossq_"  # keep for autograder
